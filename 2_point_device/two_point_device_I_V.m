% I-V Charactersitics for a two channel device
...
for ii = 1:length(V_vec)
   ...
   I_E = @(E) calculate_I_E(E,t,mu1,mu2,kT,eta);
...
title('I-V for 2 point ballistic device','fontsize',16,'interpreter','latex');