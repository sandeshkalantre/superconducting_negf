...
scaled_E_vec = E_vec./Delta;
figure(1)
str = strcat(['dos_' num2str(N_D) '_points.mat']);
save(str,'scaled_E_vec','A');
plot(scaled_E_vec,A,'linewidth',2.0)
set(gca,'FontSize',20)
ylim([0 1000])
xlabel('Energy ($\frac{E}{\Delta}$)','interpreter','latex','fontsize',24);
ylabel('Density of States','interpreter','latex','fontsize',24);
title(['DOS for number of device points : ' num2str(N_D)],'interpreter','latex','fontsize',24)
